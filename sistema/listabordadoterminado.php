...
if (empty($_GET['id'])) {
    ...
    $idbordado = $_GET['id'];
    $update=mysqli_query($conexion, "UPDATE bordado SET estado=1 WHERE idbordado=$idbordado");
...
<body>
    ...
    <section id="container">
        ...
        <a href="listabordadogeneral.php" class="btn_new" style="position:fixed ; top:150px; left: 0px;">Lista Bordado</a>


        <center>
            <div style="width:100%">

                <h1>Lista de pedidos Terminados y Anulados para BORDADO</h1>
            ...
            WHERE bor.estado>2");
                    ...
                    <td>" . $data['estado'] . "</td>
                    <td><div>
                    <a title=\"Editar\"class=\"link_edit\"href=\"listabordadoterminado.php?id=" . $data['idbordado'] . "\"><span class=\"glyphicon glyphicon-share\" aria-hidden=\"true\"></span></a>
