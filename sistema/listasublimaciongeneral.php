...
<a href="reporte_sublimacion.php" class="btn_new" style="position:fixed ; top:150px; left: 0px;">Reporte</a>


<center><div style="width:100%">

<h1>Lista General de Pedidos para SUBLIMACIÓN</h1>
        ...
        <table id="tabla" class="display" >
         <thead>   
            <tr class="titulo">
                ...
                <th colspan="9"> Información sublimacion</th>
            </tr>   
             <tr class="titulo">
                <th>Pedido</th>
                <th>Cliente</th>
        ...
        <tbody>
            ...
            su.inicioprocesofecha, su.finprocesofecha, su.parcial, us.usuario, su.obs_sublimacion, pr.siglas, es.estado, est.estado as 'estadopedido'
            FROM pedidos pe 
            ...
            if ($result>0){
                while($data=mysqli_fetch_array($query)){
                   ...
                   echo " <td>".$data['siglas']."</td>
                    ...
                    <td>".$data['iniciosublimacion']."</td>
                    <td>".$data['finsublimacion']."</td>
                    <td>".$data['diassublimacion']."</td>";
                    ...
                    echo "<td>".$parcial."</td>
                    <td>".$falta."</td>
                    <td>".$data['obs_sublimacion']."</td>
                    <td>".$data['estado']."</td>
                    <td><div>
                    <a title=\"Editar\"class=\"link_edit\"href=\"editar_sublimacion.php?id=".$data['idsublimacion']."\"><span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span></a>
                    <a title=\"Finalizar\"class=\"link_edit\"href=\"finalizar_sublimacion.php?id=".$data['idsublimacion']."\"><span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span></a>
                    <a title=\"Anular\"class=\"link_delete\"href=\"anular_sublimacion.php?id=".$data['idsublimacion']."\"><span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span></a>
