        ...
        <table style="width:50% !important; ">
            ...
            <tbody>
                <tr>
                    ...
                    <td background="red"><?php $query=mysqli_query($conexion,"SELECT * FROM estampacion WHERE finfecha<'$hoy' AND estado<=2"); echo mysqli_num_rows($query)?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT * FROM estampacion WHERE estado<=2 AND finfecha BETWEEN'$hoy' AND '$tresdias' "); echo mysqli_num_rows($query)?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT * FROM estampacion WHERE finfecha>='$cuatrodias' AND estado<=2"); echo mysqli_num_rows($query)?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT * FROM estampacion WHERE  estado<=2"); echo mysqli_num_rows($query)?></td>
                </tr>
                <tr>
                    <th class="titulo">Unds Listas</th>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(parcial) as 'suma' FROM estampacion WHERE finfecha<'$hoy' AND estado<=2"); $result=mysqli_fetch_array($query); echo $result['suma'];?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(parcial) as 'suma' FROM estampacion WHERE estado<=2 AND finfecha BETWEEN'$hoy' AND '$tresdias'"); $result=mysqli_fetch_array($query); echo $result['suma'];?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(parcial) as 'suma' FROM estampacion WHERE finfecha>='$cuatrodias' AND estado<=2"); $result=mysqli_fetch_array($query); echo $result['suma'];?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(parcial) as 'suma' FROM estampacion WHERE  estado<=2"); $result=mysqli_fetch_array($query); echo $result['suma'];?></td>
                </tr>
                <tr>
                    ...
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(pe.unds-estam.parcial) as 'resta' FROM estampacion estam INNER JOIN pedidos pe ON estam.pedido=pe.idpedido
                                                            WHERE estam.estado<=2 AND estam.finfecha<'$hoy'"); $result=mysqli_fetch_array($query); echo $result['resta'];?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(pe.unds-estam.parcial) as 'resta' FROM estampacion estam INNER JOIN pedidos pe ON estam.pedido=pe.idpedido
                                                            WHERE estam.estado<=2 AND estam.finfecha BETWEEN'$hoy' AND '$tresdias'"); $result=mysqli_fetch_array($query); echo $result['resta'];?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(pe.unds-estam.parcial) as 'resta' FROM estampacion estam INNER JOIN pedidos pe ON estam.pedido=pe.idpedido
                                                            WHERE estam.estado<=2 AND estam.finfecha>='$cuatrodias'"); $result=mysqli_fetch_array($query); echo $result['resta'];?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(pe.unds-estam.parcial) as 'resta' FROM estampacion estam INNER JOIN pedidos pe ON estam.pedido=pe.idpedido
                                                            WHERE estam.estado<=2"); $result=mysqli_fetch_array($query); echo $result['resta'];?></td>
                </tr>
                <tr>
                    ...
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(pe.unds) as 'suma' FROM estampacion estam INNER JOIN pedidos pe ON estam.pedido=pe.idpedido
                                                            WHERE estam.estado<=2 AND estam.finfecha<'$hoy'"); $result=mysqli_fetch_array($query); echo $result['suma'];?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(pe.unds) as 'suma' FROM estampacion estam INNER JOIN pedidos pe ON estam.pedido=pe.idpedido
                                                            WHERE estam.estado<=2 AND estam.finfecha BETWEEN'$hoy' AND '$tresdias'"); $result=mysqli_fetch_array($query); echo $result['suma'];?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(pe.unds) as 'suma' FROM estampacion estam INNER JOIN pedidos pe ON estam.pedido=pe.idpedido
                                                            WHERE estam.estado<=2 AND estam.finfecha>='$cuatrodias'"); $result=mysqli_fetch_array($query); echo $result['suma'];?></td>
                    <td><?php $query=mysqli_query($conexion,"SELECT SUM(pe.unds) as 'suma' FROM estampacion estam INNER JOIN pedidos pe ON estam.pedido=pe.idpedido
                                                            WHERE estam.estado<=2"); $result=mysqli_fetch_array($query); echo $result['suma'];?></td>
                </tr>
            </tbody>
        </table>
        </div>
        ...
        <table id="tabla" >
         <thead>  
            ...
            <tr class="titulo">
                ...
                <th colspan="8"> Información estampacion</th>
            </tr>   
             <tr class="titulo">
                <th >Pedido</th>
                <th>Cliente</th>
