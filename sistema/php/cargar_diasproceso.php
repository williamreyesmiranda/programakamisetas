...
include "cargar_diashabiles.php";     
...
if($dato1!=''){
   ...
   <center> <h3 style="text-transform: uppercase; "><?php echo $dato1?></h3>
   <div>
...
if($dato2!=''){
    ...
    ?>
   <div style="border: 1px solid #00a8a8; border-radius: 10px; ">
   <center> <h3 style="text-transform: uppercase; "><?php echo $dato2?></h3>
   <div>
...
if($dato3!=''){
    ...
    ?>
   <div style="border: 1px solid #00a8a8; border-radius: 10px; ">
   <center> <h3 style="text-transform: uppercase; "><?php echo $dato3?></h3>
   <div>
...
if($dato4!=''){
    ...
    ?>
   <div style="border: 1px solid #00a8a8; border-radius: 10px; ">
   <center> <h3 style="text-transform: uppercase; "><?php echo $dato4?></h3>
   <div>
...
if($dato5!=''){
    ...
    ?>
   <div style="border: 1px solid #00a8a8; border-radius: 10px; ">
   <center> <h3 style="text-transform: uppercase; "><?php echo $dato5?></h3>
   <div>
...
if($dato6!=''){
    ...
    ?>
   <div style="border: 1px solid #00a8a8; border-radius: 10px; ">
   <center> <h3 style="text-transform: uppercase; "><?php echo $dato6?></h3>
   <div>
